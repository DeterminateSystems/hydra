...
(my $status, my $stdout, my $stderr) =
  Hydra::Helper::Nix::captureStdoutStderr(5, "nix-env", "--json", "--query", "--available", "--attr-path", "--file",
    $defaultnix);
...
is($keys, [ "packageset-nested", "packageset.deeper.deeper.nested", "packageset.nested", "packageset.nested2", ]);
